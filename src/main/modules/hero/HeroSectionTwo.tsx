...
const HeroSectionTwo = () => {
    return (
        <div className='relative w-screen h-screen flex items-center justify-center  bg-gradient-to-r from-cyan-500 to-blue-500 text-[#F5F5F5] lg:text-9xl text-5xl'>
            <div className='flex flex-col flex-wrap max-w-4xl items-center justify-center gap-2'>
            ...
            <div className='absolute lg:left-0 flex flex-col text-4xl max-w-9 justify-between gap-8 mx-4 items-center left-0 sm:block hidden'>
            ...
            <div className='absolute top-0 mx-auto my-5 text-xl'>
