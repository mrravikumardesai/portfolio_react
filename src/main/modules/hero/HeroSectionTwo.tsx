...
const HeroSectionTwo = () => {
    return (
        ...
        <motion.section
            initial={{ opacity: 1, y: -10 }}
            whileInView={{ opacity: 1, y: 0, }}
            className='w-full h-[30vh] flex flex-col items-center justify-center lg:text-9xl text-5xl'>

            <h1 className='londrina-outline-regular text-center  text-4xl md:text-4xl p-4'>On demand <span className='londrina-solid-regular '>dynamic</span>  full stack  <span className='londrina-solid-regular '>developer</span></h1>
